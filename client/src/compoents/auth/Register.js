    ...
    return (
        <div className="form-background">
            <div className="form-container">
                <h1>Account <span style={{color:'#93FE00'}}>Register</span></h1>
                <form onSubmit={onSubmit}>
                    <div className="form-group">
                        <label htmlFor="name" style={{color:'#93FE00'}}>Name</label>
                    ...
                    <div className="form-group">
                        <label htmlFor="password2" style={{color:'#93FE00'}}>Confirm Password</label>
